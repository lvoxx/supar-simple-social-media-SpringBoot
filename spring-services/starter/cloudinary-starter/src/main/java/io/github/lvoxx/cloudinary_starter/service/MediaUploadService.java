...
public abstract class MediaUploadService {
     ...
     */
    protected Mono<String> uploadMedia(
            String publicId,
            String mediaData,
            String resourceType,
     ...
     */
    protected Mono<String> uploadImage(String publicId, String imageData,
            Transformation<EagerTransformation> transformation) {
     ...
     */
    protected Mono<String> uploadVideo(String publicId, String videoData,
            Transformation<EagerTransformation> transformation) {
