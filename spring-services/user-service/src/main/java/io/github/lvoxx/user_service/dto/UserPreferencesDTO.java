...
public class UserPreferencesDTO {
        ...
        @Pattern(regexp = "^(https?|ftp)://[^\\s/$.?#].[^\\s]*$", message = "Avatar URL must be a valid URL")
        @Schema(description = "Avatar URL", example = "https://res.cloudinary.com/demo/image/upload/sample.jpg")
        private String avatarUrl;

        @Pattern(regexp = "^(https?|ftp)://[^\\s/$.?#].[^\\s]*$", message = "Cover image URL must be a valid URL")
        @Schema(description = "Cover image URL", example = "https://res.cloudinary.com/demo/image/upload/landscape.jpg")
